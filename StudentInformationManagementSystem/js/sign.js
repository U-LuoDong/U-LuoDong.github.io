...
function getCode() {
	$.ajax({
		url: 'http://www.text2.com/demo1/StudentInformationManagementSystem/getCode.php',
		type: 'POST',
		dataType: 'json',
...
//刷新验证码
function shuaxin() {
	document.getElementById('code').src = "http://www.text2.com/demo1/StudentInformationManagementSystem/VerificationCode.php?" + Math.random();
	var code = getCode();
