...
function GeneratClass() {
	$.ajax({
		url: 'http://www.text2.com/demo1/StudentInformationManagementSystem/Function_1_class.php',
		type: 'POST',
		dataType: 'json',
		data: {
			data: ZYselectedText
...
function GeneratNum() {
	$.ajax({
		url: 'http://www.text2.com/demo1/StudentInformationManagementSystem/Function_1.php',
		type: 'POST',
		dataType: 'json',
		data: {
			//这里是请求参数，前面是键名，后面是值
...
function GeneratSp() {
	$.ajax({
		url: 'http://www.text2.com/demo1/StudentInformationManagementSystem/Function_2.php',
		type: 'POST',
		dataType: 'json',
		data: {
			//这里是请求参数，前面是键名，后面是值
...
function GeneratSc() {
	$.ajax({
		url: 'http://www.text2.com/demo1/StudentInformationManagementSystem/Function_3.php',
		type: 'POST',
		dataType: 'json',
		data: {
			//这里是请求参数，前面是键名，后面是值
