...
//	安全防护开始
$defnce = new defence;
$XB = $defnce->clean_xss($_POST['sc']); //防注入代码   
//	安全防护结束
$strSql="select className from class as cl,specialty as sp where sp.specialtyName ='$XB' and cl.specialtyName=sp.specialtyName";//查询
//预处理 生成专业对应的班级
