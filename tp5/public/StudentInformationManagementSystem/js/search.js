function To_Modify(){
	window.location.href='http://www.tp5.com/studentinformationmanagementsystem/student/modify.html';
}
//适应网页大小开始
//浏览器窗口大小被改变时触发事件
...
function GeneratInfo() {
	$.ajax({
		url: 'http://www.tp5.com/studentinformationmanagementsystem/student/search.html',
		type: 'POST',
		dataType: 'json',
		data: {
			//这里是请求参数，前面是键名，后面是值
...
//									alert("1");
			...
			document.getElementById("Function_Sid_1").innerHTML = msg[6]; //添加班级信息
