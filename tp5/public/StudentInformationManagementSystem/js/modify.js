//将查看到的信息放在输入框中开始
document.getElementById("txt_1").value = document.getElementById("num").innerHTML;
document.getElementById("txt_2").value = document.getElementById("grade").innerHTML;
document.getElementById("txt_3").value = document.getElementById("className").innerHTML;
document.getElementById("txt_4").value = document.getElementById("sid").innerHTML;
document.getElementById("txt_5").value = document.getElementById("sname").innerHTML;
document.getElementById("txt_6").value = document.getElementById("sex").innerHTML;
document.getElementById("txt_7").value = document.getElementById("level").innerHTML;
//将查看到的信息放在输入框中结束
//适应网页大小开始
//浏览器窗口大小被改变时触发事件
